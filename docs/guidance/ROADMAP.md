...
- [ ] Sync Y.js updates to Postgres for persistence. (See **[DATABASE.md](./DATABASE.md)**)
...
- [ ] Implement Streaming Response (SSE) pipeline. (See **[BACKEND.md](./BACKEND.md)**)
- [ ] Build Frontend SSE consumer with typing animation. (See **[FRONTEND.md](./FRONTEND.md)**)

## 🔍 Phase 5: Context & RAG
*Goal: The AI knows what you wrote.*
- [ ] Enable `pgvector` and create embedding tables. (See **[DATABASE.md](./DATABASE.md)**)
