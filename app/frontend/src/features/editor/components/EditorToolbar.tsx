...
function FontFamilySelect({ editor }: { editor: Editor }) {
  ...
  return (
    <select
      ...
      className="h-8 rounded-[4px] border border-border-subtle bg-transparent px-2 text-ui-sm text-text-primary cursor-pointer focus:outline-none focus:border-accent-main focus:ring-1 focus:ring-accent-main/40"
      aria-label="Font family"
      title="Font family"
    >
      <option value="">Default (Merriweather)</option>
...
export function EditorToolbar({ editor }: EditorToolbarProps) {
  return (
    <div
      className="ui-peripheral sticky top-14 z-30 flex flex-wrap items-center gap-0.5 border-b border-border-subtle bg-surface px-3 py-1.5"
      role="toolbar"
